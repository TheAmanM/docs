...
description: "Every software engineer comes to a certain point in their career. The point where they stop..."
"og:image": "http://amanmeherally.com/blogs/30-08-2025-hero.png"
---

<p className="-mt-8 lg:-mt-6">30th August, 2025</p>
...
Despite Mintlify compiling to Next JS, it was clear that they hadn't exposed any way to re-write Posthog requests. Which sucked.

So I pulled up my trusty AI agent, and discovered after a good twenty minutes that there simply was no solution.
...
And once I realized this, the game was simple. I deployed an Express server to [api.amanmeherally.com](https://api.amanmeherally.com), set up an HTTP proxy middleware object on a router, and the rest was history.
